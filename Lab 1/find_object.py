...
# cv2.createTrackbar('HMin', 'mask', 0, 179, lambda x: None)
# cv2.createTrackbar('SMin', 'mask', 0, 255, lambda x: None)
# cv2.createTrackbar('VMin', 'mask', 0, 255, lambda x: None)
# cv2.createTrackbar('HMax', 'mask', 0, 179, lambda x: None)
# cv2.createTrackbar('SMax', 'mask', 0, 255, lambda x: None)
# cv2.createTrackbar('VMax', 'mask', 0, 255, lambda x: None)
...
while(1):
    ...
    #ballLower = (cv2.getTrackbarPos('HMin', 'mask'), cv2.getTrackbarPos('SMin', 'mask'), cv2.getTrackbarPos('VMin', 'mask'))
    #ballUpper = (cv2.getTrackbarPos('HMax', 'mask'), cv2.getTrackbarPos('SMax', 'mask'), cv2.getTrackbarPos('VMax', 'mask'))
